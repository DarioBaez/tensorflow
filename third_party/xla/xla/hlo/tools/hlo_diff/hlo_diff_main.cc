...
const char* const kUsage = R"(
    ...
    If --ignore_shape_during_instruction_matching is specified, the tool ignores array/tensor shapes when matching instructions allowing for more permissive matches.
    If --text_output is specified, the full diff result will be printed in text format and saved to the specified file.
    if --html_output is specified, the diff result will be rendered in HTML format and saved to the specified path.
    )";
